...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-white text-black fixed top-0 left-0 right-0 z-50 ${
                sticky
            ...
            <div className="navbar ">
                        ...
                        <div className="dropdown">
                         ...
                         <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-7 6h16" /></svg>
                          ...
                          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"> {navItem}
                          </ul>
                    ...
                    <div className="hidden md:block ">
                        <label className="input input-bordered dark:bg-white dark:text-black flex items-center gap-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 cursor-pointer opacity-70"><path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" /></svg>
                        </label>
                    </div>
                  ...
                  <div className="">
                    <a className=" dark:bg-pink-500 text-white px-3 py-2 hover:bg-slate-800 duration-300  cursor-pointer rounded-md">Login</a>
                    </div>
                    </div>
                    </div>
            </div>
